...
A.prototype.M = function() {
  if (!this.oa && (this.oa = !0, this.v(), 0 != jb)) {
    var a = ea(this);
    delete kb[a];
  }
};
function lb(a, b) {
  a.oa ? n(void 0) ? b.call(void 0) : b() : (a.Ga || (a.Ga = []), a.Ga.push(n(void 0) ? w(b, void 0) : b));
}
...
function of(a, b, c, d, e) {
  if (t(b)) {
    ...
    c = gf(c), vb(a) ? a.fa(b, c, d, e) : a && (a = jf(a)) && (b = a.Va(b, c, !!d, e)) && pf(b);
  }
}
function pf(a) {
...
f.gb = function(a, b, c) {
  ...
  Fg(a, this);
  Nb(this.j, b, 0, a);
  a.J && this.J && a.o == this ? (c = this.Aa(), b = c.childNodes[b] || null, b != a.g() && c.insertBefore(a.g(), b)) : c ? (this.b || this.I(), b = U(this, b + 1), Hg(a, this.Aa(), b ? b.b : null)) : this.J && !a.J && a.b && a.b.parentNode && 1 == a.b.parentNode.nodeType && a.S();
};
f.Aa = function() {
  return this.b;
};
function Lg(a) {
  null == a.xa && (a.xa = ag(a.J ? a.b : a.a.a.body));
  return a.xa;
}
function Kg(a) {
...
f.Qc = function(a) {
  ...
  if (!this.o || this.b || b && !qe(a)) {
    ...
    if (this.dispatchEvent(new Wg("start", this, a.clientX, a.clientY))) {
      ...
      this.B && this.a.w(this.B, "scroll", this.Fd, d);
...
f.Ma = function(a) {
  return a.a.A("DIV", gh(this, a).join(" "), a.Ba);
};
function hh(a, b, c) {
  if (a = a.g ? a.g() : a) {
    var d = [b];
...
f.cd = function() {
  nh() || (this.c.fa(this.g(), "click", this.Ac), this.ra = null);
  this.wb = !1;
  ph(this);
};
f.hd = function(a) {
...
function ph(a) {
  ...
  xf(b, "label", a.h);
  qh(a) ? (b = a.g(), cc(b, "label-input-label")) : (a.B || a.wb || (b = a.g(), ac(b, "label-input-label")), nh() || tg(a.Ld, 10, a));
}
f.ia = function(a) {
  this.g().disabled = !a;
  var b = this.g();
...
f.$a = r;
function th(a, b) {
  a.X && a.dispatchEvent({type:"beforehide", target:b}) && (a.c && If(a.c), a.X = !1, la(), a.B ? (nf(a.B, "end", ka(a.jc, b), !1, a), a.B.play()) : a.jc(b));
}
f.jc = function(a) {
...
Ch.prototype.I = function() {
  var a = this.a;
  this.b = a.A("FIELDSET", null, a.A("LEGEND", null, this.R), this.lc());
};
...
f.S = function() {
  ...
  this.T & 8 && a.na(b, 8, !!(this.O & 8));
  this.T & 16 && a.na(b, 16, !!(this.O & 16));
  this.T & 64 && a.na(b, 64, !!(this.O & 64));
  this.c.sc(this);
...
function Jh(a, b) {
  var c = T(a), d = a.g();
  b ? (c.w(d, "mouseover", a.Sb).w(d, "mousedown", a.ob).w(d, "mouseup", a.ub).w(d, "mouseout", a.Vb), a.ab != r && c.w(d, "contextmenu", a.ab), H && (K(9) || c.w(d, "dblclick", a.zc), a.B || (a.B = new Kh(a), lb(a, ka(B, a.B))))) : (c.fa(d, "mouseover", a.Sb).fa(d, "mousedown", a.ob).fa(d, "mouseup", a.ub).fa(d, "mouseout", a.Vb), a.ab != r && c.fa(d, "contextmenu", a.ab), H && (K(9) || c.fa(d, "dblclick", a.zc), B(a.B), a.B = null));
}
f.aa = function() {
  V.l.aa.call(this);
  this.h && Cg(this.h);
...
function Ph(a, b, c, d) {
  d || 1 != b ? a.T & b && c != !!(a.O & b) && (a.c.Qb(a, b, c), a.O = c ? a.O | b : a.O & ~b) : a.ia(!c);
}
function Sh(a, b, c) {
  if (a.J && a.O & b && !c) {
    throw Error("Component already rendered");
...
function Mh(a, b, c) {
  return !!(a.T & b) && !!(a.O & b) != c && (!(a.Ea & b) || a.dispatchEvent(Eg(b, c))) && !a.oa;
}
f.Sb = function(a) {
...
f.I = function() {
  ...
  Ye(a, !0);
  R(a, !1);
  this.fc && !this.U && (this.U = this.a.A("IFRAME", {frameborder:0, style:"border:0;vertical-align:bottom;", src:Df}), this.U.className = this.pb() + "-bg", R(this.U, !1), $f(this.U, 0));
  this.$ || (this.$ = this.a.A("DIV", this.pb() + "-bg"), R(this.$, !1));
  this.ga || (this.ga = this.a.a.createElement("SPAN"), R(this.ga, !1), Ye(this.ga, !0), this.ga.style.position = "absolute");
};
f.Nc = function() {
  this.Jb = !1;
};
  ...
  if (a != this.ta) {
    if (this.F && this.F.stop(), this.R && this.R.stop(), this.C && this.C.stop(), this.H && this.H.stop(), this.J && Xh(this, a), a) {
      ...
      if (this.dispatchEvent("beforehide")) {
        T(this).fa(Le(this.a.a), "resize", this.Fb).fa(Le(this.a.a), "orientationchange", this.pa);
        this.ta = !1;
...
f.Dd = function(a) {
  this.Jb ? this.Nc() : a.target == this.ga && tg(this.oc, 0, this);
};
f.oc = function() {
  try {
...
f.I = function() {
  this.b = this.a.A("DIV", this.lb.a(this).join(" "));
};
f.Aa = function() {
  return this.g();
};
...
f.ia = function(a) {
  this.La != a && this.dispatchEvent(a ? "enable" : "disable") && (a ? (this.La = !0, Ig(this, function(a) {
    a.Tc ? delete a.Tc : a.ia(!0);
  })) : (Ig(this, function(a) {
    a.isEnabled() ? a.ia(!1) : a.Tc = !0;
...
f.I = function() {
  ...
  this.Ra = b.A("DIV", this.m + "-title", this.Fa = b.A("SPAN", {className:this.m + "-title-text", id:this.N()}, this.Sc), this.ma = b.A("SPAN", this.m + "-title-close"));
  Re(a, this.Ra, this.Ta = b.A("DIV", this.m + "-content"), this.ha = b.A("DIV", this.m + "-buttons"));
  wf(this.Fa, "heading");
  wf(this.ma, "button");
  Ye(this.ma, !0);
  xf(this.ma, "label", ui);
  ...
  R(this.ma, !0);
  this.c && (a = this.c, a.sa = this.ha, vi(a));
  R(this.ha, !!this.c);
  this.Ib = this.Ib;
...
f.S = function() {
  ...
  T(this).w(this.ha, "click", this.zd);
  ti(this, !0);
  T(this).w(this.ma, "click", this.Hd);
  var a = this.g();
  wf(a, "dialog");
...
f.Ma = function(a) {
  ...
  a.Hb &= -256;
  Sh(a, 32, !1);
  return a.a.A("BUTTON", {"class":gh(this, a).join(" "), disabled:!a.isEnabled(), title:a.Ja() || "", value:a.F || ""}, Lh(a) || "");
};
f.sc = function(a) {
...
function Hi(a, b, c) {
  ...
  $h.call(this, this.b.A("DIV", {style:"position:absolute;display:none;"}));
  this.o = new G(1, 1);
  this.D = new ye;
  this.h = null;
  a && Ii(this, a);
...
function Si(a, b) {
  if (a.xa && a.xa.contains(b) || a.yb(b)) {
    return !0;
  }
  a = a.m;
  return !!a && a.yb(b);
...
function Ui(a, b, c) {
  ...
  this.c = a;
  bi.call(this, this.wa, b || vh.za(), c);
  Vi(this);
}
x(Ui, bi);
...
f.kc = function() {
  ...
  var b = this.a;
  this.ya = b.A("SELECT", null, a(""));
  E(this.h, function(b) {
    b = a(b);
    this.ya.appendChild(b);
  }, this);
  return b.A("LABEL", null, "Browser:\u00a0", this.ya);
};
f.Pb = function() {
  return this.h[this.ya.selectedIndex - 1];
};
f.Cc = function() {
...
function ej() {
  ...
  ri(this.m, "Delete session?");
  si(this.m, fd("Are you sure you want to delete this session?"));
  P(this.m, Ai, this.pa, !1, this);
  this.B = new Ti("Delete Session");
  Jg(this, this.B);
  P(this.B, "action", w(this.m.V, this.m, !0));
  this.C = new Ti("Take Screenshot");
  Jg(this, this.C);
  P(this.C, "action", this.Ha, !1, this);
  this.h = new cj;
  this.h.C = new L(5, 5, 5, 5);
  this.h.mc = !0;
  var a = this.h, b = new L(10, 0, 0, 0);
...
function fj(a, b) {
  ...
  if (b) {
    ...
    for (var c = "", d = 0; d < b.length; d++) {
      var e = b[d], c = c + (e instanceof cd ? ed(e) : e);
    }
    a.innerHTML = c;
  }
}
...
function hj(a) {
  ...
  P(this.B, "action", this.Ad, !1, this);
}
x(hj, Ch);
f = hj.prototype;
f.v = function() {
...
function ij(a) {
  return (a = a.c.W) ? a.Ca : null;
}
f.Nd = function() {
  if (this.h.length) {
    var a = this.h[0].Ba, a = 5 === a.length ? "." : a + ".";
    E(this.h, function(b) {
      var c = a;
      kh(b.g(), c);
      b.Ba = c;
...
function lj(a, b) {
  ...
  E(b, function(a) {
    var b = a.Ca.N(), g = c.get(b);
    g ? (ld(c, b), a.Ca = g) : (d.removeChild(a, !0), e === a && (e = null));
  }, a);
  E(a.h, function(a) {
    d.removeChild(a, !0);
  });
  a.h = [];
  E(c.ba(), a.gc, a);
  e ? (fj(a.m, e.Ca), Xi(d, e)) : Kg(d) ? Xi(d, U(d, 0)) : fj(a.m, null);
}
f.Ad = function() {
  var a = ".";
  this.h.length && (a = this.h[0].Ba);
  a = new Gi(a, null, this.a);
  a.ia(!1);
  this.h.push(a);
  Jg(this.c, a, !0);
  jj(this);
  this.dispatchEvent(new tc("create", this, this.B.Pb()));
};
f.Gd = function() {
  var a = this.c.W;
  fj(this.m, a ? a.Ca : null);
};
function kj(a) {
